    ...
    return (
        <div className='home-wrapper'>
            <div className='popular-destinations-div'>
                <h2 className='home-headers'>Popular Destinations:</h2>
                <div className='popular-destinations-wrapper'>
                    ...
                    <ul>
                        ...
                        <Link to='/weather/Ireland/Dublin' className='popular-destination-anchor'><li className='popular-destination-items'>Dublin, Ireland</li></Link>
